...
namespace CovGym
{
    public partial class frmPago : Form
    {
        ...
        private void frmPago_Load(object sender, EventArgs e)
        {
            ...
            StreamWriter objWriter = new StreamWriter(@"c:\archivos\reportes\comprobantepago.html");
            string sLine = "";
            ...
            sLine += "<h4><b>     TOTAL CON LETRA:</b>       " + tls.ConvertFloatToString(float.Parse(frmMensualidad.costo)).ToUpper() +"</h4>";
            sLine += "</pre></td></tr>";
            objWriter.WriteLine(sLine);
            objWriter.WriteLine("</tbody></table></div></body></html>");
            objWriter.Close();
            Uri dir = new Uri(@"c:\archivos\reportes\comprobantepago.html");
            webBrowser1.Url = dir;
        }
